...
preserve 
    ...
    tab gr_`r'
    table gr_`r',c(mean in_floor_permanent mean in_roof_permanent mean in_wall_permanent mean san_flush mean h20_piped_in) format(%9.2f) center
	table gr_`r',c(mean in_size_big mean in_sep_kitch) format(%9.2f) center
restore
}
