**********************************
***NSS69 for housing condition****
**********************************

//This file is to consolidate the surveys

global ROOT "C:/Users/wb500886/OneDrive - WBG/7_Housing/NSS69"
global raw "${ROOT}/raw"
...
destring `var',replace  
	...
	*hq_pwall: wall type is pucca: 
	...
	gen infra_pucca_wall = inrange(b6_q14,5,9)
	...
	*hq_proof: roof type is pucca
	...
	gen infra_pucca_roof = inrange(b6_q15,5,9)
...
*****generate extra indicator*****
	...
	*cost of utility cost (water, sanitation)
	...
	//gen hq_san_rate = hq_san_cost / hh_mce //no sanitation cost in nss69
...
save "${final}/nss69",replace
save "${raw_batch}/nss69",replace
